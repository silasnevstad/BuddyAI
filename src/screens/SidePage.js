      ...
      <Background>
        <div className="App">
          ...
          <main className="App-main">
            ...
            <SideTextInput text={text} responseText={responseText} setText={setText} setResponseText={setResponseText} style={style} prompt={prompt} isLoading={isLoading} />
